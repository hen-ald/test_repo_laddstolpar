...
Följande är en visualisering av publika laddstationer i Dalarna. Definition av publik laddning – "en laddstation som står placerad där vem som helst kan ladda bilen, till exempel utmed landsvägar, i parkeringshus, vid köpcentrum, vid infartsparkeringar eller resecentrum." (Energimyndigheten, https://www.energimyndigheten.se/klimat--miljo/transporter/energieffektiva-och-fossilfria-fordon-och-transporter/laddinfrastruktur/).

Laddstationer har olika mängd anslutningspunkter. Diagrammet nedan visar summan av anslutningspunkter per kommun.
...
I nuläget kan två lager kan tändas/släckas. Det primära lagret är punkter vilka visualiserar placering av laddstationer. När muspekaren vilar på en punkt visas antal anslutningspunkter på aktuell station. Det andra lagret är ett polygonlager med antalet anslutningspunkter aggregerat till kommunnivå, när muspekaren vilar på en kommun visas summan av anslutningspunkter på samtliga stationer i aktuell kommun. Vänsterklick på ett objekt visar all tillgänglig information.
